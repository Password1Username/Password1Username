...
class MySprite():
    ...
    def getImageValues(self):
        ...
        '''Collision parameters scaled'''
        self.collision_x1_scaled = self.collision_x1 * self.scaleinx
        self.collision_x2_scaled = self.collision_x1_scaled + self.width_scaled
        self.collision_y1_scaled = self.collision_y2 * self.scaleiny
        self.collision_y2_scaled = self.collision_y2_scaled + self.height_scaled
        self.collision_width_scaled = self.width_scaled
        self.collision_height_scaled = self.height_scaled
    ...
    def setCollisionPos(self, collX1, collX2, collY1, collY2):
        ...
        ''' Scaled quantities'''
        self.collision_x1_scaled = self.collision_x1*self.scaleinx
        self.collision_x2 = self.collision_x2*self.scaleinx
        self.collision_y1 = self.collision_y1*self.scaleiny
        self.collision_y2 = self.collision_y2*self.scaleiny
        self.collision_width = self.collision_x2_scaled - self.collision_x1_scaled
        self.collision_height = self.collision_y2_scaled - self.collision_y1_scaled
        self.collision_rect_scaled = pygame.Rect(self.collision_x1_scaled, self.collision_y1_scaled,self.collision_width_scaled,self.collision_height_scaled)
